...
public class StructueBoundaryElectricdistributionstationBoundaryLimitePoDto {
    ...
    public StructueBoundaryElectricdistributionstationBoundaryLimitePoDto() {}

    public StructueBoundaryElectricdistributionstationBoundaryLimitePoDto(StructueBoundaryElectricdistributionstationBoundaryLimitePo e) {
        if (e == null) return;
        this.id = e.getId();
