...
public class StructureJunctionElectricLowVoltagePolePoteauBtDto {
    ...
    public StructureJunctionElectricLowVoltagePolePoteauBtDto() {}

    public StructureJunctionElectricLowVoltagePolePoteauBtDto(StructureJunctionElectricLowVoltagePolePoteauBt e) {
        if (e == null) return;
        this.id = e.getId();
