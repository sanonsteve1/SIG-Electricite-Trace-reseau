...
public class ElectricDeviceMediumVoltageArresterParafoudreDto {
    ...
    public ElectricDeviceMediumVoltageArresterParafoudreDto() {}

    public ElectricDeviceMediumVoltageArresterParafoudreDto(ElectricDeviceMediumVoltageArresterParafoudre e) {
        if (e == null) return;
        this.id = e.getId();
        ...
        this.currentdevicestatus = e.getCurrentdevicestatus();
        this.arrestertype = e.getArrestertype();
