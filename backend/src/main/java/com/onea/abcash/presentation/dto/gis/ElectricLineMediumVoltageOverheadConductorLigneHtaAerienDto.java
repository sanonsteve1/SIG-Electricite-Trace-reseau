...
public class ElectricLineMediumVoltageOverheadConductorLigneHtaAerienDto {
    ...
    public ElectricLineMediumVoltageOverheadConductorLigneHtaAerienDto() {}

    public ElectricLineMediumVoltageOverheadConductorLigneHtaAerienDto(ElectricLineMediumVoltageOverheadConductorLigneHtaAerien e) {
        if (e == null) return;
        this.id = e.getId();
