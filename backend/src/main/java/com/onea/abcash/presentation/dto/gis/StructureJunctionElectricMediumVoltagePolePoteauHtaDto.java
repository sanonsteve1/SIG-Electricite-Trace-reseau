...
public class StructureJunctionElectricMediumVoltagePolePoteauHtaDto {
    ...
    public StructureJunctionElectricMediumVoltagePolePoteauHtaDto() {}

    public StructureJunctionElectricMediumVoltagePolePoteauHtaDto(StructureJunctionElectricMediumVoltagePolePoteauHta e) {
        if (e == null) return;
        this.id = e.getId();
        ...
        this.earthing = e.getEarthing();
        this.template = e.getTemplate();
        this.equipmenttypeorclass = e.getEquipmenttypeorclass();
        this.grounding = e.getGrounding();
        this.accessorylv = e.getAccessorylv();
        this.presenceofastreetlamp = e.getPresenceofastreetlamp();
        ...
        this.flag = e.getFlag();
        this.archedcrossarm = e.getArchedcrossarm();
        this.alternatingorstaggered = e.getAlternatingorstaggered();
        this.triangle = e.getTriangle();
        this.canadianstylecrossarm = e.getCanadianstylecrossarm();
        this.horizontalcrossarm = e.getHorizontalcrossarm();
        this.others = e.getOthers();
        this.pa25 = e.getPa25();
        this.suspensionclampwithbracket = e.getSuspensionclampwithbracket();
        this.tensionclampwithbracket = e.getTensionclampwithbracket();
        this.anglechampra25 = e.getAnglechampra25();
        this.crossarm = e.getCrossarm();
        this.sidearm = e.getSidearm();
        this.inclinedarm = e.getInclinedarm();
        this.deadendarm = e.getDeadendarm();
        this.anglearm = e.getAnglearm();
        this.doublearm = e.getDoublearm();
    }
