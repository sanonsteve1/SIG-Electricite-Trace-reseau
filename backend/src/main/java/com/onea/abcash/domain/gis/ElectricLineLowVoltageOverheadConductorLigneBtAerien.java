...
@Entity
@Table(name = "ElectricLine_LowVoltageOverheadConductor_ligne_bt_aerien")
public class ElectricLineLowVoltageOverheadConductorLigneBtAerien {

    @Id
    @SequenceGenerator(name = "ElectricLine_LowVoltageOverheadConductor_ligne_bt_aerien_id_seq", sequenceName = "ElectricLine_LowVoltageOverheadConductor_ligne_bt_aerien_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ElectricLine_LowVoltageOverheadConductor_ligne_bt_aerien_id_seq")
    private Integer id;
