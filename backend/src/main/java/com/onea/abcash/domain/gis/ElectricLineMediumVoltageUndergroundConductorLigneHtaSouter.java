...
@Entity
@Table(name = "ElectricLine_MediumVoltageUndergroundConductor_ligne_hta_souter")
public class ElectricLineMediumVoltageUndergroundConductorLigneHtaSouter {

    @Id
    @SequenceGenerator(name = "ElectricLine_MediumVoltageUndergroundConductor_ligne_hta_souter_id_seq", sequenceName = "ElectricLine_MediumVoltageUndergroundConductor_ligne_hta_souter_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ElectricLine_MediumVoltageUndergroundConductor_ligne_hta_souter_id_seq")
    private Integer id;
