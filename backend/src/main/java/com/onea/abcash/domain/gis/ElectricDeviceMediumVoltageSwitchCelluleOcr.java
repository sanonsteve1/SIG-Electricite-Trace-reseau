...
@Entity
@Table(name = "ElectricDevice_MediumVoltageSwitch_cellule_ocr")
public class ElectricDeviceMediumVoltageSwitchCelluleOcr {

    @Id
    @SequenceGenerator(name = "ElectricDevice_MediumVoltageSwitch_cellule_ocr_id_seq", sequenceName = "ElectricDevice_MediumVoltageSwitch_cellule_ocr_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ElectricDevice_MediumVoltageSwitch_cellule_ocr_id_seq")
    private Integer id;
