...
@Entity
@Table(name = "ElectricDevice_LowVoltageNetworkProtection_Disjoncteur")
public class ElectricDeviceLowVoltageNetworkProtectionDisjoncteur {

    @Id
    @SequenceGenerator(name = "ElectricDevice_LowVoltageNetworkProtection_Disjoncteur_id_seq", sequenceName = "ElectricDevice_LowVoltageNetworkProtection_Disjoncteur_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ElectricDevice_LowVoltageNetworkProtection_Disjoncteur_id_seq")
    private Integer id;
