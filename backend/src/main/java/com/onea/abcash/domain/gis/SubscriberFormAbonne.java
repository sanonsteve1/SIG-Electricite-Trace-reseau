...
@Entity
@Table(name = "SubscriberForm_abonne")
public class SubscriberFormAbonne {

    @Id
    @SequenceGenerator(name = "SubscriberForm_abonne_id_seq", sequenceName = "SubscriberForm_abonne_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SubscriberForm_abonne_id_seq")
    private Integer id;
