...
@Entity
@Table(name = "ElectricDevice_Ground_Terre")
public class ElectricDeviceGroundTerre {

    @Id
    @SequenceGenerator(name = "ElectricDevice_Ground_Terre_id_seq", sequenceName = "ElectricDevice_Ground_Terre_id_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ElectricDevice_Ground_Terre_id_seq")
    private Integer id;
